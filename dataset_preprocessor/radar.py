...
def arg_parser():
    parser = argparse.ArgumentParser(description="Preprocessing Radar data")
...
def main():
    ...
    for seq_dir in (sequence_dirs):
        if args.mode == "sc":
            ...
            # out_dir = out_base_dir / seq_dir.name / "single_chip" / "radarcube_upsample"
            out_dir = out_base_dir / seq_dir.name / "single_chip" / "radarcube_raw"
